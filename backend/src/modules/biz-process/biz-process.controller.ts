...
@ApiTags('biz-process')
@Controller('biz-processes')
export class BizProcessController {
  constructor(private readonly service: BizProcessService) {}

  @Post()
  @ApiOperation({ summary: '创建工程咨询业务流程' })
  create(@Body() data: Partial<BizProcess>) {
    return this.service.create(data);
  }

  @Get('list')
  @ApiOperation({ summary: '获取工程咨询业务流程列表' })
  findAll(@Query() query: any) {
    return this.service.findAll(query);
  }

  @Get(':id')
  @ApiOperation({ summary: '获取工程咨询业务流程详情' })
  findOne(@Param('id', ParseIntPipe) id: number) {
    return this.service.findOne(id);
  }

  @Put(':id')
  @ApiOperation({ summary: '更新工程咨询业务流程' })
  update(@Param('id', ParseIntPipe) id: number, @Body() data: Partial<BizProcess>) {
    return this.service.update(id, data);
  }

  @Delete(':id')
  @ApiOperation({ summary: '删除/停用工程咨询业务流程' })
