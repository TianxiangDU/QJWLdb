...
@Injectable()
export class BizProcessService {
  constructor(
    @InjectRepository(BizProcess)
    private readonly repository: Repository<BizProcess>,
  ) {}

  async create(data: Partial<BizProcess>): Promise<BizProcess> {
  ...
  async findAll(query: any): Promise<PaginationResultDto<BizProcess>> {
  ...
  async findOne(id: number): Promise<BizProcess> {
  ...
  async update(id: number, data: Partial<BizProcess>): Promise<BizProcess> {
