...
@Injectable()
export class CostRuleService {
  constructor(
    @InjectRepository(CostRule)
    private readonly repository: Repository<CostRule>,
  ) {}

  async create(data: Partial<CostRule>): Promise<CostRule> {
  ...
  async findAll(query: any): Promise<PaginationResultDto<CostRule>> {
  ...
  async findOne(id: number): Promise<CostRule> {
  ...
  async update(id: number, data: Partial<CostRule>): Promise<CostRule> {
