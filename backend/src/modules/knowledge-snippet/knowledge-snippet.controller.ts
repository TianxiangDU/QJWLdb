...
@ApiTags('knowledge-snippet')
@Controller('knowledge-snippets')
export class KnowledgeSnippetController {
  constructor(private readonly service: KnowledgeSnippetService) {}

  @Post()
  @ApiOperation({ summary: '创建工程碎片知识' })
  create(@Body() data: Partial<KnowledgeSnippet>) {
    return this.service.create(data);
  }

  @Get('list')
  @ApiOperation({ summary: '获取工程碎片知识列表' })
  findAll(@Query() query: any) {
    return this.service.findAll(query);
  }

  @Get(':id')
  @ApiOperation({ summary: '获取工程碎片知识详情' })
  findOne(@Param('id', ParseIntPipe) id: number) {
    return this.service.findOne(id);
  }

  @Put(':id')
  @ApiOperation({ summary: '更新工程碎片知识' })
  update(@Param('id', ParseIntPipe) id: number, @Body() data: Partial<KnowledgeSnippet>) {
    return this.service.update(id, data);
  }

  @Delete(':id')
  @ApiOperation({ summary: '删除/停用工程碎片知识' })
