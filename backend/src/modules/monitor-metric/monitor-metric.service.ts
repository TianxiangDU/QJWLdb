...
@Injectable()
export class MonitorMetricService {
  constructor(
    @InjectRepository(MonitorMetric)
    private readonly repository: Repository<MonitorMetric>,
  ) {}

  async create(data: Partial<MonitorMetric>): Promise<MonitorMetric> {
  ...
  async findAll(query: any): Promise<PaginationResultDto<MonitorMetric>> {
  ...
  async findOne(id: number): Promise<MonitorMetric> {
  ...
  async update(id: number, data: Partial<MonitorMetric>): Promise<MonitorMetric> {
